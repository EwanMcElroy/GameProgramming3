...
public:
	...
	inline void setForward(glm::vec3 _for) { m_forward = _for; } // set forward
	inline void setRight(glm::vec3 _right) { m_right = _right; } // set right
	inline void setUp(glm::vec3 _Up) { m_up = _Up; } //set up
